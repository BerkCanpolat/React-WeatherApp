...
import type { ForecastData } from "@/Api/Core/Weather.types";

interface HourlyTemperatureProps {
    hourlyForecast: ForecastData;
}

const HourlyTemperature = ({ hourlyForecast }: HourlyTemperatureProps) => {
    
    const chartData = hourlyForecast.list.slice(0,8).map((item) => ({
